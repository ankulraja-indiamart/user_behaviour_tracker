...
const normalizeInsightsPayload = (value) => {
...
const parseLlmInsightsOutput = (value) => {
...
const buildChatPrompt = (question) => `You are an expert user behavior analyst working for IndiaMART.
...
export async function llmAnalyze(req, res) {
  try {
...
export async function llmChat(req, res) {
  try {
